...
CUSTOM_COMMAND_SIG(mb_last_serach_forward)
{
...
mb_set_bindings(Mapping *mapping)
{
 ...
 Bind(f4_move_right_token_boundary, KeyCode_W);
 Bind(f4_move_left_token_boundary, KeyCode_B);
 Bind(set_mark, KeyCode_V);
 Bind(f4_search, KeyCode_F, KeyCode_Control);
 Bind(mb_last_search_backward, KeyCode_N, KeyCode_Shift);
 Bind(mb_last_serach_forward, KeyCode_N);
 Bind(undo, KeyCode_U);
 Bind(undo, KeyCode_R, KeyCode_Shift);
 Bind(f4_go_to_definition_same_panel, KeyCode_G, KeyCode_Shift);
 Bind(f4_code_peek, KeyCode_P, KeyCode_Shift);
 Bind(f4_code_peek_yank, KeyCode_Y, KeyCode_Shift);
 ...
 Bind(keyboard_macro_finish_recording, KeyCode_U, KeyCode_Shift, KeyCode_Control);
